...
| Safe Markdown planning/patching | In progress | M5 is adding section-aware preview/review/apply tooling |
| Web, desktop, mobile, notebook, and research execution | Planned | Surface drivers are not implemented yet |
| Stale tracking | Planned | Roadmap milestone M6 |
...
DemoWeave is in active development. M0–M4 established the monorepo, repository analyzer, Flow/Evidence contracts, terminal driver, and PNG/GIF renderer. **Pilot P0 is complete:** DemoWeave now dogfoods that stack in this README using its own captured and rendered runtime evidence. M5 is building the general safe Markdown planning/patching layer.

See [ROADMAP.md](ROADMAP.md) for milestone boundaries and future surface drivers. The Markdown patcher, stale regeneration, browser automation, and tutorial composition remain unshipped until their milestones land.
